	...
	foreach( $new_order as $k => $v ) {				
		...
		if ( 'background-color' === $k ) {
			...
			echo '<span class="gp-color-picker-field gp-styling-field ' . $field_class . '">';
				...
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Color', 'gpur' ) . '</label>';
			...
			echo '<span class="gp-media-field gp-styling-field ' . $field_class . '" data-id="' . esc_attr( $new_id ) . '">';
			
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Image', 'gpur' ) . '</label>';
				...
				echo '<input type="hidden" id="' . esc_attr( $new_id ) . '" name="' . esc_attr( $new_name ) . '" value="' . esc_attr( $new_value ) . '" />';
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Repeat', 'gpur' ) . '</label>';
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Size', 'gpur' ) . '</label>';
				echo '<select id="' . esc_attr( $new_id ) . '" class="post_form" name="' . esc_attr( $new_name ) . '">';
  					$option_values = array(
						'inherit' => esc_html__( 'Inherit', 'gpur' ),
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Attachment', 'gpur' ) . '</label>';
				echo '<select id="' . esc_attr( $new_id ) . '" class="post_form" name="' . esc_attr( $new_name ) . '">';
  					$option_values = array(
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Position', 'gpur' ) . '</label>';
				echo '<select id="' . esc_attr( $new_id ) . '" class="post_form" name="' . esc_attr( $new_name ) . '">';
  					$option_values = array(
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Clip', 'gpur' ) . '</label>';
				echo '<select id="' . esc_attr( $new_id ) . '" class="post_form" name="' . esc_attr( $new_name ) . '">';
			...
			echo '<span class="gp-select-field gp-styling-field ' . $field_class . '">';
				echo '<label for="' . esc_attr( $new_id ) . '" class="gp-label">' . esc_html__( 'Background Origin', 'gpur' ) . '</label>';
				echo '<select id="' . esc_attr( $new_id ) . '" class="post_form" name="' . esc_attr( $new_name ) . '">';
					echo '<option value=""></option>';
  					$option_values = array(
						'inherit'     => esc_html__( 'Inherit', 'gpur' ),
