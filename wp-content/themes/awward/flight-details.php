						...
						<div class="innerStyle departure">
							<div class="times" style="border-bottom:1px solid white">
								...
								<div class="timeBlock" style="width:50%;display:inline-block">
									...
									<?php
										...
										$departure_gate_date_time_actual_value = '--';
										...
										if($flight_data['flightStatus']['operationalTimes']['actualGateDeparture']['dateLocal'] != NULL) {
											...
											$departure_gate_date_time_actual_value = $departure_gate_date_time_actual->format('H:i');
									...
									<div>
										<h4 style="display:inline-block;margin:0;font-weight:bold"><?= $departure_gate_date_time_actual_value; ?></h4>
										
										<?php if ($departure_gate_date_time_actual_value != '--'): ?>
											<p class="timeDetails" style="padding-left:1px;text-transform:uppercase"> </p>
											<p class="timeDetails" style="padding-left:2px;text-transform:uppercase"><span>&nbsp;</span>CDT</p>
										<?php endif ?>
							...
							<div class="times" style="border-bottom:1px solid white">
								...
								<?php
									...
									var_dump($flight_data['flightStatus']['operationalTimes']['flightPlanPlannedDeparture']['dateLocal']);
